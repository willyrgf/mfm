#[cfg(test)]
mod tests {
    use crate::keystore::keystore::{Keystore, KeystoreError};
    ...
    const TEST_MNEMONIC_2_VALID: &str =
        "test test test test test test test test test test test junk"; // Known valid mnemonic
