...
use alloy_signer_local::PrivateKeySigner; // Ensuring this is the one used
...
impl Keystore {
        ...
        let file_path = match custom_path {
            ...
            None => {
                ...
                if !app_data_dir.exists() {
                    fs::create_dir_all(&app_data_dir).map_err(|e| KeystoreError::Io(e))?;
                }
    ...
    pub fn import_mnemonic(
        ...
        let xprv = XPrv::derive_from_path(seed_bytes_array.as_slice(), &derivation_path)
            .map_err(|e| KeystoreError::Bip32(e))?;
