...
runtime. The builder API should make the common invalid combinations unrepresentable: a
side-effecting forward node should not be able to reach a terminal public output without an
attached directive, and a compensation directive should require a typed obligation target before
the program draft can be finalized.
