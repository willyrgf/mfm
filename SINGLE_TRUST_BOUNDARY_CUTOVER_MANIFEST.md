...
Status: superseded as design authority by `RFC_RUNTIME_STORE_JOURNAL_TYPED_PROOF.md`; retained
through Commit 1 only as the temporary legacy negative-scan input. It is not current product
authority and will be replaced by the selected cutover manifest in Commit 2.
