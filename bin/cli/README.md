...
`missing_fact`, `receipt_mismatch`, `candidate_bound_exhausted`, `unsupported_requirement`, and
`ambiguous_facts`. `inconsistent_network_anchors` is a residual hard-fail guard (not a product
soft path). Generic
