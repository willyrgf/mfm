...
consumer E2E supplies configuration and checks final reports. These are requirements, not claims
that the capabilities already exist. Detailed fault verification belongs in separate tests.
