...
| Exact 32 MiB object/report limits and precise root-value/context errors | [Values](../crates/kernel/values/tests/value_contract.rs), [reports](../crates/kernel/runtime/tests/report_capacity.rs), [qualification](../crates/kernel/runtime/tests/support/qualification_capacity.rs) |
