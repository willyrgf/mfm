...
| Acknowledged-prefix preservation on a real collection restart | [Portfolio policies](../crates/domains/portfolio/tests/recovery_policy.rs) |
| Route-aware planning, checked full-width snapshots and compiled product execution | [Planning](../crates/domains/portfolio/tests/planning_contract.rs), [snapshot extremes](../crates/domains/portfolio/src/snapshot_extremes.rs), [App use cases](../crates/app/tests/use_cases.rs) |
...
| Incomplete/forged/lost-ack publication; transport delete/resume/dependent admission | [App use cases](../crates/app/tests/use_cases.rs), managed [CLI/REST e2e](../bin/rest-api/tests/client_execution_e2e.rs) |

## RFC acceptance evidence

| Criteria | Observable evidence |
| --- | --- |
| 1 | [App use cases](../crates/app/tests/use_cases.rs) associate the real heterogeneous EVM/Portfolio State sequence with the single framework Stop. [Scoped Program tests](../crates/kernel/program/src/tests.rs) retain parameters, targets and explicit zero independently. [Portfolio collection restart](../crates/domains/portfolio/tests/recovery_policy.rs) preserves the acknowledged prefix. |
...
| 4–5 | [App use cases](../crates/app/tests/use_cases.rs) retain original/root snapshot failures; [Runtime contracts](../crates/kernel/runtime/tests/runtime_contract.rs) preserve internal-failure boundaries. [Pending audit](../crates/kernel/runtime/tests/pending_failure/audit.rs) retains original cause, executed input and decision. |
