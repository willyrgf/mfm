...
- `cache/aave-v3-origin/lib/forge-std/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/forge-std/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/contracts/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/lib/forge-std/lib/ds-test/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/lib/forge-std/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/lib/openzeppelin-contracts/contracts/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/lib/openzeppelin-contracts/lib/forge-std/lib/ds-test/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/lib/openzeppelin-contracts/lib/forge-std/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/lib/openzeppelin-contracts/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/lib/openzeppelin-contracts/scripts/solhint-custom/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/lib/openzeppelin-contracts-upgradeable/scripts/solhint-custom/package.json` (node-package)
- `cache/aave-v3-origin/lib/solidity-utils/package.json` (node-package)
- `cache/aave-v3-origin/package.json` (node-package)
...
- `crates/ops/aave-v3-configure-runtime-op/Cargo.toml` (rust-cargo)
- `crates/ops/aave-v3-deploy-runtime-op/Cargo.toml` (rust-cargo)
- `crates/ops/aave-v3-origin-adapt-op/Cargo.toml` (rust-cargo)
- `crates/ops/aave-v3-scenario-op/Cargo.toml` (rust-cargo)
