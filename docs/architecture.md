...
| Config repository port | immutable named revisions, atomic current selection, exact load, and complete listing | config-wire parsing, Program semantics, merging, or deletion |
