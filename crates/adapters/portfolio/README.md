...
store-verified input evidence, artifact-read capabilities, and EVM read capabilities from
runtime/app assembly, executes the portfolio read or pure behavior, and stages typed fact/artifact
evidence through those supplied boundaries.
