...
#[derive(Debug, Clone)]
pub(super) enum VerifiedContractSideEffectIntent {
    Deploy(Box<ContextContractDeployIntent>),
    Configure(Box<ContextContractConfigureIntent>),
}

pub(super) fn verify_replay_intent_matches_prepared(
    intent: &replay::SideEffectIntentReplayEvidence,
    prepared: &PreparedContractInvocation,
...
pub(super) fn verify_prepared_transaction_data_matches_inputs(
    prepared: &PreparedContractInvocation,
...
pub(super) fn verify_contract_receipt_schema(schema: &SchemaId) -> replay::Result<()> {
...
pub(super) fn verify_contract_receipt_artifact(
    schema: &SchemaId,
    artifact_bytes: &[u8],
    prepared: &PreparedContractInvocation,
) -> replay::Result<()> {
...
pub(super) fn verify_contract_confirmation_schema(
    schema: &SchemaId,
    artifact_bytes: &[u8],
    required_depth: u64,
) -> replay::Result<()> {
