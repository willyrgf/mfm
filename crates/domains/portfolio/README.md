...
Portfolio owns checked process-local selector/config authoring, target resolution, Program/C0
...
Five Pure States implement Program contracts directly. The domain has no Runtime, Store, provider,
