...
This crate owns the one checked TLS-root authority used by live EVM transports. The exhaustive
choices are compiled WebPKI anchors or an absolute PEM file whose exact bytes match a
caller-supplied `content:sha256-v1` digest.
