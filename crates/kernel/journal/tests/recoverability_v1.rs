...
fn every_owned_schema_round_trips_its_frozen_golden_vectors() {
    ...
    assert_eq!(schemas.len(), 90, "every journal-owned schema must execute");
    assert!(
        vectors >= schemas.len(),
...
fn source_and_manifest_contain_no_legacy_event_api() {
    let source = [
        include_str!("../src/v1/mod.rs"),
        include_str!("../src/v1/access.rs"),
        include_str!("../src/v1/codec.rs"),
        include_str!("../src/v1/commit.rs"),
        include_str!("../src/v1/fact.rs"),
        include_str!("../src/v1/input.rs"),
        include_str!("../src/v1/object.rs"),
        include_str!("../src/v1/record.rs"),
        include_str!("../src/v1/refs.rs"),
        include_str!("../src/v1/transition.rs"),
