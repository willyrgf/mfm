...
use mfm_canonical::{
    CanonicalValue, RecoverabilityContractV3, RecoverabilityError, ValidatedCanonicalValueV3,
};
use mfm_ids::{
    ...
    (
        ...
        $(
            ...
            impl $name {
                ...
                pub fn strict_decode(bytes: &[u8]) -> $crate::v2::Result<Self> {
                    $crate::v2::codec::decode(bytes)
                }
                ...
                ) -> $crate::v2::Result<Self> {
                    $crate::v2::codec::encode(&value)
                }
                ...
                pub fn canonical_value(
                    &self,
                ) -> $crate::v2::Result<mfm_canonical::CanonicalValue> {
                    self.validated.canonical_value().map_err(Into::into)
                }

                /// Returns the raw-byte content reference for this exact value.
                pub fn content_ref(&self) -> $crate::v2::Result<mfm_ids::ContentRef> {
                    $crate::v2::codec::contract()?
                        .content_ref(&self.validated)
                        .map_err(Into::into)
                }
            }

            impl $crate::v2::codec::sealed::Sealed for $name {}

            impl $crate::v2::PersistedJournalValue for $name {
                fn validated(&self) -> &mfm_canonical::ValidatedCanonicalValueV3 {
                    &self.validated
                }
            }

            impl $crate::v2::codec::SchemaValue for $name {
...
pub trait PersistedJournalValue: sealed::Sealed {
    ...
    fn validated(&self) -> &ValidatedCanonicalValueV3;
...
pub(crate) trait SchemaValue: PersistedJournalValue + Sized {
    ...
    fn from_validated(validated: ValidatedCanonicalValueV3) -> Self;
}
