    ...
    (
        ...
        $(
            ...
            impl $name {
                ...
                pub fn strict_decode(bytes: &[u8]) -> $crate::v1::Result<Self> {
                    $crate::v1::codec::decode(bytes)
                }
                ...
                pub fn canonical_value(
                    &self,
                ) -> $crate::v1::Result<mfm_canonical::CanonicalValue> {
                    self.validated.canonical_value().map_err(Into::into)
                }

                /// Returns the raw-byte content reference for this exact value.
                pub fn content_ref(&self) -> $crate::v1::Result<mfm_ids::ContentRef> {
                    $crate::v1::codec::contract()?
            ...
            impl $crate::v1::codec::SchemaValue for $name {
