...
#[tokio::test]
async fn trace_export_executes_the_complete_recoverability_v2_corpus() {
    recoverability_v2_support::run_consumer("mfm-trace-export", |vector| {
        ...
        if vector.kind() == "export_identity" {
            ...
            let stream = recoverability_v2_support::hex_field(vector.vector(), "stream_hex");
