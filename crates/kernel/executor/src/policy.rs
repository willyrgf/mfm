...
pub struct PolicyDecision<Allocation> {
    ...
    pub(crate) allocation_state: ValidatedCanonicalValue,
...
impl<Allocation> PolicyDecision<Allocation> {
    ...
    pub fn new(
        ...
        allocation_state: ValidatedCanonicalValue,
    ...
    pub const fn allocation_state(&self) -> &ValidatedCanonicalValue {
...
pub trait TypedResourcePolicy: Send + Sync {
    ...
    ) -> std::result::Result<ValidatedCanonicalValue, PolicyError>;
