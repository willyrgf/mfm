...
pub struct ResourceAllocationEvidence {
    ...
    typed_allocation_state: ValidatedCanonicalValueV1,
...
impl ResourceAllocationEvidence {
    ...
    pub const fn resource_key_value(&self) -> &ValidatedCanonicalValueV1 {
    ...
    pub const fn typed_allocation_state(&self) -> &ValidatedCanonicalValueV1 {
...
pub struct ResourceLedgerRecord {
    ...
    pub(crate) resource_key_value: ValidatedCanonicalValueV1,
    ...
    pub(crate) typed_allocation_state: ValidatedCanonicalValueV1,
