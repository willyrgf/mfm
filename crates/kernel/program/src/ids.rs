...
pub(super) fn input_descriptor_id(input_schema_id: &SchemaId) -> Result<DescriptorId> {
    digest_only_id(
        "input-descriptor",
...
pub(super) fn collect_input_cell_ids(node: &InputBindingNode, output: &mut Vec<CellId>) {
    match &node.kind {
...
pub(super) fn validate_input_binding_node(node: &InputBindingNode) -> Result<()> {
    match &node.kind {
...
pub(super) fn validate_input_binding_node_shape(
...
pub(super) fn schema_shape_kind(shape: &SchemaShape) -> &'static str {
    match shape {
...
pub(super) fn input_binding_node_kind_from_kind(kind: &InputBindingNodeKind) -> &'static str {
    match kind {
...
pub(super) fn input_binding_digest(root: &InputBindingNode) -> Result<ContentDigest> {
...
pub(super) fn input_binding_node_json(node: &InputBindingNode) -> serde_json::Value {
    match &node.kind {
...
pub(super) fn input_context_from_cell_context(context: &CellContextSpec) -> InputContextSpec {
    match context {
...
pub(super) fn input_context_json(context: &InputContextSpec) -> serde_json::Value {
    match context {
