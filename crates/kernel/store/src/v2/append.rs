...
impl ObserveExternalAccess {
    ...
    pub(super) fn new(
        ...
        let returned = matches!(
            ...
            mfm_journal::v2::ObservationOutcomeFields::Returned { .. }
        );
...
impl AssignedJournalAppend {
    fn new(
        ...
        let expected_sequence = match core.expected_predecessor.fields()? {
            mfm_journal::v2::JournalPredecessorFields::Genesis { .. } => 1,
            mfm_journal::v2::JournalPredecessorFields::JournalHead(head) => head
                .run_sequence
                .checked_add(1)
                .ok_or(StoreError::SequenceOverflow)?,
        };
