...
use mfm_canonical::{RecoverabilityContractV3, ReferenceTerminalKindV3};
...
struct PrefixClosureWalker<'a> {
    contract: &'static RecoverabilityContractV3,
        ...
        Box::pin(async move {
            ...
            for transition in view.transition_entries() {
                let fields = transition
                    ...
                    .map_err(StoreError::from)
                    .map_err(B::Error::from)?;
                let mfm_journal::v2::TransitionBodyFields::ReadSettled {
