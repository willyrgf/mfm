...
CREATE TABLE mfm_config.mfm_config_schema (
    ...
    CONSTRAINT mfm_config_schema_contract_check
        CHECK (schema_contract = 'mfm.config-postgres.v2')
);

INSERT INTO mfm_config.mfm_config_schema (schema_contract)
VALUES ('mfm.config-postgres.v2');
...
GRANT SELECT, INSERT, DELETE ON TABLE mfm_config.config_revisions TO mfm_runtime;
