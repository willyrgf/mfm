...
The EVM adapter owns bounded provider ingress, protocol authentication, committed-call binding,
nonce authority, signing, and raw-response disposal. `EvmLiveAssembly::install` validates and
